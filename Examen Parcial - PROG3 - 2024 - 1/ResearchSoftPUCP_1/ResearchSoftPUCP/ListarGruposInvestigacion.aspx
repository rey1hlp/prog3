...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    <div class="container">
        ...
        <div class="container row">
            <div class="row align-items-center">
                ...
                <div class="col-sm-2 p-2">
                    <asp:LinkButton ID="lbBuscar" runat="server" CssClass="btn btn-info" Text="<i class='fa-solid fa-magnifying-glass pe-2'></i> Buscar" />
                </div>
        ...
        <div class="container row">
            <asp:GridView ID="gvGruposInvestigacion" runat="server" AllowPaging="true" PageSize="5" AutoGenerateColumns="false" CssClass="table table-hover table-responsive table-striped" OnPageIndexChanging="gvGruposInvestigacion_PageIndexChanging">
                <columns>
                    ...
                    <asp:TemplateField>
                        <itemtemplate>
                            <asp:LinkButton CssClass="btn btn-warning" runat="server" Text="<i class='fa-solid fa-eye'></i> Mostrar Datos" />
                        </itemtemplate>
                    </asp:TemplateField>
                </columns>
            </asp:GridView>
